...
volatile unsigned long save_xsp = 0x00000000;
volatile unsigned long save_xssp = 0x00000000;
...
volatile unsigned long root_xsp = 0x00000000;
volatile unsigned long root_xssp = 0x00000000;

unsigned char first_flag = 0x00000000;
unsigned long save_xar7 = 0x00000000;
unsigned long  save_xar6 = 0x00000000;
unsigned long save_xar1 = 0x00000000;
...
volatile	unsigned int DBSTAT_SAVE = 0x0000; // 0x001F or 0x005F seems to be safe;
...
//	TACTL |= MC_1;
	...
	Timer0Init();
    IER0 = 0x0010;      // enable timer int  TINT
    DBIER0 = 0x0010;
	StartTimer0();
