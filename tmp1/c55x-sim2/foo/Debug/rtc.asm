...
;* Date/Time created: Sun Sep 30 01:34:01 2018                                 *
;*******************************************************************************
...
;	F:\t\cc5p5\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@f:\\AppData\\Local\\Temp\\1746012 
	.sect	".text"
	.align 4
...
$C$DW$9	.dwtag  DW_TAG_subprogram, DW_AT_name("enable_rtc_second_int")
	...
	.dwattr $C$DW$9, DW_AT_TI_begin_file("../src/rtc.c")
	.dwattr $C$DW$9, DW_AT_TI_begin_line(0x2e)
	.dwattr $C$DW$9, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$9, DW_AT_TI_max_frame_size(0x01)
	.dwpsn	file "../src/rtc.c",line 47,column 1,is_stmt,address _enable_rtc_second_int
...
_enable_rtc_second_int:
	...
	.dwpsn	file "../src/rtc.c",line 49,column 5,is_stmt
        MOV #1, *port(#6400) ; |49| 
	.dwpsn	file "../src/rtc.c",line 50,column 5,is_stmt
        MOV #2, *port(#6436) ; |50| 
	.dwpsn	file "../src/rtc.c",line 51,column 1,is_stmt
$C$DW$10	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$10, DW_AT_low_pc(0x00)
	.dwattr $C$DW$10, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$9, DW_AT_TI_end_file("../src/rtc.c")
...
$C$DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("reset_RTC")
	...
	.dwattr $C$DW$11, DW_AT_TI_begin_file("../src/rtc.c")
	.dwattr $C$DW$11, DW_AT_TI_begin_line(0x35)
	.dwattr $C$DW$11, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$11, DW_AT_TI_max_frame_size(0x02)
	.dwpsn	file "../src/rtc.c",line 54,column 1,is_stmt,address _reset_RTC
...
$C$DW$12	.dwtag  DW_TAG_variable, DW_AT_name("temp")
	...
	.dwpsn	file "../src/rtc.c",line 57,column 5,is_stmt
        MOV *port(#6400), AR1 ; |57| 
        MOV AR1, *SP(#0) ; |57| 
	.dwpsn	file "../src/rtc.c",line 58,column 5,is_stmt
        MOV #0, *port(#6400) ; |58| 
	.dwpsn	file "../src/rtc.c",line 60,column 5,is_stmt
        MOV #0, *port(#6404) ; |60| 
	.dwpsn	file "../src/rtc.c",line 61,column 5,is_stmt
        MOV #0, *port(#6408) ; |61| 
	.dwpsn	file "../src/rtc.c",line 62,column 5,is_stmt
        MOV #0, *port(#6412) ; |62| 
	.dwpsn	file "../src/rtc.c",line 63,column 5,is_stmt
        MOV #0, *port(#6416) ; |63| 
	.dwpsn	file "../src/rtc.c",line 64,column 5,is_stmt
        MOV #16, *port(#6420) ; |64| 
	.dwpsn	file "../src/rtc.c",line 65,column 5,is_stmt
        MOV #6, *port(#6424) ; |65| 
	.dwpsn	file "../src/rtc.c",line 66,column 5,is_stmt
        MOV #8201, *port(#6428) ; |66| 
	.dwpsn	file "../src/rtc.c",line 68,column 5,is_stmt
        MOV #32768, *port(#6401) ; |68| 
	.dwpsn	file "../src/rtc.c",line 70,column 11,is_stmt
...
$C$L2:    
	.dwpsn	file "../src/rtc.c",line 72,column 5,is_stmt
        MOV *SP(#0), AR1 ; |72| 
        MOV AR1, *port(#6400) ; |72| 
	.dwpsn	file "../src/rtc.c",line 73,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$14	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$14, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\rtc.asm:$C$L1:1:1538296441")
...
$C$DW$15	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$11, DW_AT_TI_end_file("../src/rtc.c")
...
$C$DW$16	.dwtag  DW_TAG_subprogram, DW_AT_name("NtoC")
	...
	.dwattr $C$DW$16, DW_AT_TI_begin_file("../src/rtc.c")
	...
	.dwpsn	file "../src/rtc.c",line 77,column 1,is_stmt,address _NtoC
...
$C$DW$18	.dwtag  DW_TAG_variable, DW_AT_name("num")
	...
	.dwattr $C$DW$18, DW_AT_location[DW_OP_bregx 0x24 0]
        MOV T0, *SP(#0) ; |77| 
	.dwpsn	file "../src/rtc.c",line 78,column 5,is_stmt
        B $C$L14  ; |78| 
                                        ; branch occurs ; |78| 
$C$L3:    
	.dwpsn	file "../src/rtc.c",line 81,column 13,is_stmt
        MOV #48, *SP(#0) ; |81| 
	.dwpsn	file "../src/rtc.c",line 82,column 9,is_stmt
        B $C$L15  ; |82| 
                                        ; branch occurs ; |82| 
$C$L4:    
	.dwpsn	file "../src/rtc.c",line 84,column 13,is_stmt
        MOV #49, *SP(#0) ; |84| 
	.dwpsn	file "../src/rtc.c",line 85,column 9,is_stmt
        B $C$L15  ; |85| 
                                        ; branch occurs ; |85| 
$C$L5:    
	.dwpsn	file "../src/rtc.c",line 87,column 13,is_stmt
        MOV #50, *SP(#0) ; |87| 
	.dwpsn	file "../src/rtc.c",line 88,column 9,is_stmt
        B $C$L15  ; |88| 
                                        ; branch occurs ; |88| 
$C$L6:    
	.dwpsn	file "../src/rtc.c",line 90,column 13,is_stmt
        MOV #51, *SP(#0) ; |90| 
	.dwpsn	file "../src/rtc.c",line 91,column 9,is_stmt
        B $C$L15  ; |91| 
                                        ; branch occurs ; |91| 
$C$L7:    
	.dwpsn	file "../src/rtc.c",line 93,column 13,is_stmt
        MOV #52, *SP(#0) ; |93| 
	.dwpsn	file "../src/rtc.c",line 94,column 9,is_stmt
        B $C$L15  ; |94| 
                                        ; branch occurs ; |94| 
$C$L8:    
	.dwpsn	file "../src/rtc.c",line 96,column 13,is_stmt
        MOV #53, *SP(#0) ; |96| 
	.dwpsn	file "../src/rtc.c",line 97,column 9,is_stmt
        B $C$L15  ; |97| 
                                        ; branch occurs ; |97| 
$C$L9:    
	.dwpsn	file "../src/rtc.c",line 99,column 13,is_stmt
        MOV #54, *SP(#0) ; |99| 
	.dwpsn	file "../src/rtc.c",line 100,column 9,is_stmt
        B $C$L15  ; |100| 
                                        ; branch occurs ; |100| 
$C$L10:    
	.dwpsn	file "../src/rtc.c",line 102,column 13,is_stmt
        MOV #55, *SP(#0) ; |102| 
	.dwpsn	file "../src/rtc.c",line 103,column 9,is_stmt
        B $C$L15  ; |103| 
                                        ; branch occurs ; |103| 
$C$L11:    
	.dwpsn	file "../src/rtc.c",line 105,column 13,is_stmt
        MOV #56, *SP(#0) ; |105| 
	.dwpsn	file "../src/rtc.c",line 106,column 9,is_stmt
        B $C$L15  ; |106| 
                                        ; branch occurs ; |106| 
$C$L12:    
	.dwpsn	file "../src/rtc.c",line 108,column 13,is_stmt
        MOV #57, *SP(#0) ; |108| 
	.dwpsn	file "../src/rtc.c",line 109,column 9,is_stmt
        B $C$L15  ; |109| 
                                        ; branch occurs ; |109| 
$C$L13:    
	.dwpsn	file "../src/rtc.c",line 111,column 13,is_stmt
        MOV #48, *SP(#0) ; |111| 
	.dwpsn	file "../src/rtc.c",line 112,column 9,is_stmt
        B $C$L15  ; |112| 
                                        ; branch occurs ; |112| 
$C$L14:    
	.dwpsn	file "../src/rtc.c",line 78,column 5,is_stmt
...
$C$SW1:	.long	$C$L3	; 0
	...
	.sect	".text"
$C$L15:    
	.dwpsn	file "../src/rtc.c",line 114,column 5,is_stmt
        MOV *SP(#0), T0 ; |114| 
	.dwpsn	file "../src/rtc.c",line 115,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 1
$C$DW$19	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$19, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$16, DW_AT_TI_end_file("../src/rtc.c")
...
$C$DW$20	.dwtag  DW_TAG_subprogram, DW_AT_name("convert_number_to_string")
	...
	.dwattr $C$DW$20, DW_AT_TI_begin_file("../src/rtc.c")
	...
	.dwpsn	file "../src/rtc.c",line 120,column 1,is_stmt,address _convert_number_to_string
...
$C$DW$26	.dwtag  DW_TAG_variable, DW_AT_name("temp0")
	...
	.dwattr $C$DW$26, DW_AT_location[DW_OP_bregx 0x24 5]
        MOV XAR0, dbl(*SP(#2))
        MOV T0, *SP(#0) ; |120| 
	.dwpsn	file "../src/rtc.c",line 123,column 5,is_stmt
        MOV T0, AR1
        AND #0x000f, AR1, AC0 ; |123| 
        MOV AC0, *SP(#5) ; |123| 
	.dwpsn	file "../src/rtc.c",line 124,column 5,is_stmt
        MOV *SP(#0), AC0 ; |124| 
        BFXTR #0x00f0, AC0, AR1 ; |124| 
        MOV AR1, *SP(#4) ; |124| 
	.dwpsn	file "../src/rtc.c",line 126,column 5,is_stmt
...
||      MOV AR1, T0
        ...
        MOV dbl(*SP(#2)), XAR3
        MOV T0, *AR3 ; |126| 
	.dwpsn	file "../src/rtc.c",line 127,column 5,is_stmt
        MOV *SP(#5), T0 ; |127| 
$C$DW$28	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../src/rtc.c",line 128,column 5,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #0, *AR3(short(#2)) ; |128| 
	.dwpsn	file "../src/rtc.c",line 129,column 1,is_stmt
        AADD #7, SP
	.dwcfi	cfa_offset, 1
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$29, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$20, DW_AT_TI_end_file("../src/rtc.c")
...
$C$DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("RTC_Isr")
	...
	.dwattr $C$DW$30, DW_AT_TI_begin_file("../src/rtc.c")
	...
	.dwpsn	file "../src/rtc.c",line 134,column 1,is_stmt,address _RTC_Isr
...
$C$DW$31	.dwtag  DW_TAG_variable, DW_AT_name("temp")
	...
	.dwpsn	file "../src/rtc.c",line 138,column 5,is_stmt
        MOV #4, *(#70) ; |138| 
	.dwpsn	file "../src/rtc.c",line 140,column 5,is_stmt
        MOV *port(#6432), AR1 ; |140| 
        MOV AR1, *SP(#0) ; |140| 
	.dwpsn	file "../src/rtc.c",line 141,column 5,is_stmt
        MOV AR1, *port(#6432) ; |141| 
	.dwpsn	file "../src/rtc.c",line 143,column 2,is_stmt
        MOV #1, *(#_Flag_RTC) ; |143| 
	.dwpsn	file "../src/rtc.c",line 144,column 2,is_stmt
        ADD #1, *(#_Conunt_RTC) ; |144| 
	.dwpsn	file "../src/rtc.c",line 145,column 1,is_stmt
        AADD #1, SP
	.dwcfi	cfa_offset, 5
        POP mmap(SP)
        POPBOTH XAR1
...
$C$DW$32	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$32, DW_AT_TI_return
        RETI
                                        ; return occurs
	.dwattr $C$DW$30, DW_AT_TI_end_file("../src/rtc.c")
