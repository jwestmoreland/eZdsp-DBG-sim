...
;	F:\t\cc5p5\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@f:\\AppData\\Local\\Temp\\0077612 
	.sect	".text"
	.align 4
...
$C$DW$22	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$22, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\flash.asm:$C$L1:1:1538296528")
...
$C$DW$36	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$36, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\flash.asm:$C$L4:1:1538296528")
