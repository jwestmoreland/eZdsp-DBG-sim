...
;* Date/Time created: Sun Sep 30 01:35:22 2018                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../FreeRTOS/Source/portable/MemMang/heap_3.c")
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("free")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("_free")
...
$C$DW$5	.dwtag  DW_TAG_subprogram, DW_AT_name("vTaskSuspendAll")
	.dwattr $C$DW$5, DW_AT_TI_symbol_name("_vTaskSuspendAll")
	.dwattr $C$DW$5, DW_AT_declaration
	.dwattr $C$DW$5, DW_AT_external

$C$DW$6	.dwtag  DW_TAG_subprogram, DW_AT_name("xTaskResumeAll")
	.dwattr $C$DW$6, DW_AT_TI_symbol_name("_xTaskResumeAll")
	.dwattr $C$DW$6, DW_AT_type(*$C$DW$T$26)
	.dwattr $C$DW$6, DW_AT_declaration
	.dwattr $C$DW$6, DW_AT_external

$C$DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("vApplicationMallocFailedHook")
	.dwattr $C$DW$7, DW_AT_TI_symbol_name("_vApplicationMallocFailedHook")
	.dwattr $C$DW$7, DW_AT_declaration
	.dwattr $C$DW$7, DW_AT_external
;	F:\t\cc5p5\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@f:\\AppData\\Local\\Temp\\0717212 
	.sect	".text"
	.align 4
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("pvPortMalloc")
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_3.c")
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0x3a)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x07)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x06)
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 59,column 1,is_stmt,address _pvPortMalloc

	.dwfde $C$DW$CIE, _pvPortMalloc
$C$DW$9	.dwtag  DW_TAG_formal_parameter, DW_AT_name("xWantedSize")
...
_pvPortMalloc:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-5, SP
	.dwcfi	cfa_offset, 6
$C$DW$10	.dwtag  DW_TAG_variable, DW_AT_name("xWantedSize")
	.dwattr $C$DW$10, DW_AT_TI_symbol_name("_xWantedSize")
	.dwattr $C$DW$10, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$10, DW_AT_location[DW_OP_bregx 0x24 0]
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("pvReturn")
	.dwattr $C$DW$11, DW_AT_TI_symbol_name("_pvReturn")
	.dwattr $C$DW$11, DW_AT_type(*$C$DW$T$3)
	.dwattr $C$DW$11, DW_AT_location[DW_OP_bregx 0x24 2]
        MOV T0, *SP(#0) ; |59| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 62,column 2,is_stmt
$C$DW$12	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$12, DW_AT_low_pc(0x00)
	.dwattr $C$DW$12, DW_AT_name("_vTaskSuspendAll")
	.dwattr $C$DW$12, DW_AT_TI_call
        CALL #_vTaskSuspendAll ; |62| 
                                        ; call occurs [#_vTaskSuspendAll] ; |62| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 64,column 3,is_stmt
        MOV *SP(#0), T0 ; |64| 
$C$DW$13	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$13, DW_AT_low_pc(0x00)
	.dwattr $C$DW$13, DW_AT_name("_malloc")
	.dwattr $C$DW$13, DW_AT_TI_call
        CALL #_malloc ; |64| 
                                        ; call occurs [#_malloc] ; |64| 
        MOV XAR0, dbl(*SP(#2))
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 67,column 2,is_stmt
$C$DW$14	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$14, DW_AT_low_pc(0x00)
	.dwattr $C$DW$14, DW_AT_name("_xTaskResumeAll")
	.dwattr $C$DW$14, DW_AT_TI_call
        CALL #_xTaskResumeAll ; |67| 
                                        ; call occurs [#_xTaskResumeAll] ; |67| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 71,column 3,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV XAR3, AC0
        BCC $C$L1,AC0 != #0 ; |71| 
                                        ; branchcc occurs ; |71| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 74,column 4,is_stmt
$C$DW$15	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$15, DW_AT_low_pc(0x00)
	.dwattr $C$DW$15, DW_AT_name("_vApplicationMallocFailedHook")
	.dwattr $C$DW$15, DW_AT_TI_call
        CALL #_vApplicationMallocFailedHook ; |74| 
                                        ; call occurs [#_vApplicationMallocFailedHook] ; |74| 
$C$L1:    
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 79,column 2,is_stmt
        MOV dbl(*SP(#2)), XAR0
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 80,column 1,is_stmt
        AADD #5, SP
	.dwcfi	cfa_offset, 1
$C$DW$16	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$16, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$8, DW_AT_TI_end_file("../FreeRTOS/Source/portable/MemMang/heap_3.c")
...
$C$DW$17	.dwtag  DW_TAG_subprogram, DW_AT_name("vPortFree")
	.dwattr $C$DW$17, DW_AT_low_pc(_vPortFree)
	.dwattr $C$DW$17, DW_AT_high_pc(0x00)
	.dwattr $C$DW$17, DW_AT_TI_symbol_name("_vPortFree")
	.dwattr $C$DW$17, DW_AT_external
	.dwattr $C$DW$17, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_3.c")
	.dwattr $C$DW$17, DW_AT_TI_begin_line(0x53)
	.dwattr $C$DW$17, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$17, DW_AT_TI_max_frame_size(0x04)
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 84,column 1,is_stmt,address _vPortFree

	.dwfde $C$DW$CIE, _vPortFree
$C$DW$18	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pv")
	.dwattr $C$DW$18, DW_AT_TI_symbol_name("_pv")
...
_vPortFree:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-3, SP
	.dwcfi	cfa_offset, 4
$C$DW$19	.dwtag  DW_TAG_variable, DW_AT_name("pv")
	.dwattr $C$DW$19, DW_AT_TI_symbol_name("_pv")
	.dwattr $C$DW$19, DW_AT_type(*$C$DW$T$3)
	.dwattr $C$DW$19, DW_AT_location[DW_OP_bregx 0x24 0]
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 85,column 2,is_stmt
        MOV dbl(*SP(#0)), XAR3
        MOV XAR3, AC0
        BCC $C$L2,AC0 == #0 ; |85| 
                                        ; branchcc occurs ; |85| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 87,column 3,is_stmt
$C$DW$20	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$20, DW_AT_low_pc(0x00)
	.dwattr $C$DW$20, DW_AT_name("_vTaskSuspendAll")
	.dwattr $C$DW$20, DW_AT_TI_call
        CALL #_vTaskSuspendAll ; |87| 
                                        ; call occurs [#_vTaskSuspendAll] ; |87| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 89,column 4,is_stmt
        MOV dbl(*SP(#0)), XAR0
$C$DW$21	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$21, DW_AT_low_pc(0x00)
	.dwattr $C$DW$21, DW_AT_name("_free")
	.dwattr $C$DW$21, DW_AT_TI_call
        CALL #_free ; |89| 
                                        ; call occurs [#_free] ; |89| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 92,column 3,is_stmt
$C$DW$22	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$22, DW_AT_low_pc(0x00)
	.dwattr $C$DW$22, DW_AT_name("_xTaskResumeAll")
	.dwattr $C$DW$22, DW_AT_TI_call
        CALL #_xTaskResumeAll ; |92| 
                                        ; call occurs [#_xTaskResumeAll] ; |92| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_3.c",line 94,column 1,is_stmt
$C$L2:    
        AADD #3, SP
	.dwcfi	cfa_offset, 1
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$23, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$17, DW_AT_TI_end_file("../FreeRTOS/Source/portable/MemMang/heap_3.c")
	.dwattr $C$DW$17, DW_AT_TI_end_line(0x5e)
