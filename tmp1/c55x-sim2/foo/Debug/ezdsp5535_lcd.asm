...
;	F:\t\cc5p5\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@f:\\AppData\\Local\\Temp\\2584412 
	.sect	".text"
	.align 4
...
$C$DW$34	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$34, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\ezdsp5535_lcd.asm:$C$L1:1:1538296443")
