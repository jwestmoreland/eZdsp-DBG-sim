...
;* Date/Time created: Sun Sep 30 01:35:26 2018                                 *
;*******************************************************************************
...
;	F:\t\cc5p5\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@f:\\AppData\\Local\\Temp\\1778012 
	.sect	".text"
	.align 4
...
$C$DW$65	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$65, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\QueueOverwrite.asm:$C$L2:1:1538296526")
...
$C$DW$73	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$73, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\QueueOverwrite.asm:$C$L4:2:1538296526")
...
$C$DW$79	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$79, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\QueueOverwrite.asm:$C$L1:1:1538296526")
...
$C$DW$95	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$95, DW_AT_name("F:\eZdsp_DBG\tmp1\c55x-sim2\foo\Debug\QueueOverwrite.asm:$C$L12:1:1538296526")
